...
HXDLIN(  43)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("EMAL Engine",0f,15,66,80))));
            	}
...
HXLINE(  83)		::String _hx_tmp = (HX_("Engine Version: ",e0,15,79,71) + ::MainMenuState_obj::emalEngineVersion);
