...
HX_DEFINE_STACK_FRAME(_hx_pos_6a4c75b5b5794831_159_new,"DialogueBoxEmal","new",0xf8282498,"DialogueBoxEmal.new","DialogueBoxEmal.hx",159,0x0ee375d8)
static const ::String _hx_array_data_2e6c38a6_1[] = {
	HX_("normal",27,72,69,30),HX_("angry",21,49,e2,22),
};
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_225_spawnCharacters,"DialogueBoxEmal","spawnCharacters",0x93f7fafd,"DialogueBoxEmal.spawnCharacters","DialogueBoxEmal.hx",225,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_279_update,"DialogueBoxEmal","update",0xd6a1a4d1,"DialogueBoxEmal.update","DialogueBoxEmal.hx",279,0x0ee375d8)
static const ::String _hx_array_data_2e6c38a6_17[] = {
	HX_("",00,00,00,00),HX_("center-",b8,f4,e5,19),
};
static const ::String _hx_array_data_2e6c38a6_18[] = {
	HX_("",00,00,00,00),HX_("center-",b8,f4,e5,19),
};
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_442_startNextDialog,"DialogueBoxEmal","startNextDialog",0x6bbd0555,"DialogueBoxEmal.startNextDialog","DialogueBoxEmal.hx",442,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_511_parseDialogue,"DialogueBoxEmal","parseDialogue",0xa1702ea3,"DialogueBoxEmal.parseDialogue","DialogueBoxEmal.hx",511,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_520_updateBoxOffsets,"DialogueBoxEmal","updateBoxOffsets",0xfa6752e6,"DialogueBoxEmal.updateBoxOffsets","DialogueBoxEmal.hx",520,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_221_boot,"DialogueBoxEmal","boot",0x2310e0fa,"DialogueBoxEmal.boot","DialogueBoxEmal.hx",221,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_222_boot,"DialogueBoxEmal","boot",0x2310e0fa,"DialogueBoxEmal.boot","DialogueBoxEmal.hx",222,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_223_boot,"DialogueBoxEmal","boot",0x2310e0fa,"DialogueBoxEmal.boot","DialogueBoxEmal.hx",223,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_273_boot,"DialogueBoxEmal","boot",0x2310e0fa,"DialogueBoxEmal.boot","DialogueBoxEmal.hx",273,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_6a4c75b5b5794831_274_boot,"DialogueBoxEmal","boot",0x2310e0fa,"DialogueBoxEmal.boot","DialogueBoxEmal.hx",274,0x0ee375d8)

void DialogueBoxEmal_obj::__construct( ::Dynamic dialogueList,::String song){
            	HX_GC_STACKFRAME(&_hx_pos_6a4c75b5b5794831_159_new)
...
HXLINE( 176)		this->textBoxTypes = ::Array_obj< ::String >::fromData( _hx_array_data_2e6c38a6_1,2);
...
Dynamic DialogueBoxEmal_obj::__CreateEmpty() { return new DialogueBoxEmal_obj; }

void *DialogueBoxEmal_obj::_hx_vtable = 0;

Dynamic DialogueBoxEmal_obj::__Create(::hx::DynamicArray inArgs)
{
	::hx::ObjectPtr< DialogueBoxEmal_obj > _hx_result = new DialogueBoxEmal_obj();
	_hx_result->__construct(inArgs[0],inArgs[1]);
	return _hx_result;
}

bool DialogueBoxEmal_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2c01639b) {
		if (inClassId<=(int)0x299c6d02) {
			if (inClassId<=(int)0x288ce903) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x288ce903;
			} else {
				return inClassId==(int)0x299c6d02;
			}
		} else {
...
void DialogueBoxEmal_obj::spawnCharacters(){
            	HX_GC_STACKFRAME(&_hx_pos_6a4c75b5b5794831_225_spawnCharacters)
...
HXLINE( 241)				Float x = ::DialogueBoxEmal_obj::LEFT_CHAR_X;
HXLINE( 242)				Float y = ::DialogueBoxEmal_obj::DEFAULT_CHAR_Y;
...
HXDLIN( 261)					x = (x2 + ::DialogueBoxEmal_obj::RIGHT_CHAR_X);
...
HX_DEFINE_DYNAMIC_FUNC0(DialogueBoxEmal_obj,spawnCharacters,(void))

void DialogueBoxEmal_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_6a4c75b5b5794831_279_update)
...
HXLINE( 298)					this->daText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(::DialogueBoxEmal_obj::DEFAULT_TEXT_X) ),( (Float)(::DialogueBoxEmal_obj::DEFAULT_TEXT_Y) ),this->textToType,false,true,((Float)0.0),((Float)0.7));
...
HXLINE( 307)								::Array< ::String > checkArray = ::Array_obj< ::String >::fromData( _hx_array_data_2e6c38a6_17,2);
...
HXLINE( 322)						::DialogueBoxEmal_obj::updateBoxOffsets(this->box);
HXLINE( 323)						{
...
HXLINE( 342)						::Array< ::String > checkArray = ::Array_obj< ::String >::fromData( _hx_array_data_2e6c38a6_18,2);
...
HXLINE( 350)				::DialogueBoxEmal_obj::updateBoxOffsets(this->box);
            			}
...
void DialogueBoxEmal_obj::startNextDialog(){
            	HX_GC_STACKFRAME(&_hx_pos_6a4c75b5b5794831_442_startNextDialog)
...
HXLINE( 474)			::DialogueBoxEmal_obj::updateBoxOffsets(this->box);
...
HXLINE( 478)				::DialogueBoxEmal_obj::updateBoxOffsets(this->box);
            			}
            		}
...
HXLINE( 491)		this->daText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(::DialogueBoxEmal_obj::DEFAULT_TEXT_X) ),( (Float)(::DialogueBoxEmal_obj::DEFAULT_TEXT_Y) ),this->textToType,false,true,curDialogue->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic),((Float)0.7));
...
HX_DEFINE_DYNAMIC_FUNC0(DialogueBoxEmal_obj,startNextDialog,(void))

Float DialogueBoxEmal_obj::LEFT_CHAR_X;

Float DialogueBoxEmal_obj::RIGHT_CHAR_X;

Float DialogueBoxEmal_obj::DEFAULT_CHAR_Y;

int DialogueBoxEmal_obj::DEFAULT_TEXT_X;

int DialogueBoxEmal_obj::DEFAULT_TEXT_Y;

 ::Dynamic DialogueBoxEmal_obj::parseDialogue(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_6a4c75b5b5794831_511_parseDialogue)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DialogueBoxEmal_obj,parseDialogue,return )

void DialogueBoxEmal_obj::updateBoxOffsets( ::flixel::FlxSprite box){
            	HX_STACKFRAME(&_hx_pos_6a4c75b5b5794831_520_updateBoxOffsets)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DialogueBoxEmal_obj,updateBoxOffsets,(void))


::hx::ObjectPtr< DialogueBoxEmal_obj > DialogueBoxEmal_obj::__new( ::Dynamic dialogueList,::String song) {
	::hx::ObjectPtr< DialogueBoxEmal_obj > __this = new DialogueBoxEmal_obj();
	__this->__construct(dialogueList,song);
	return __this;
}

::hx::ObjectPtr< DialogueBoxEmal_obj > DialogueBoxEmal_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic dialogueList,::String song) {
	DialogueBoxEmal_obj *__this = (DialogueBoxEmal_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(DialogueBoxEmal_obj), true, "DialogueBoxEmal"));
	*(void **)__this = DialogueBoxEmal_obj::_hx_vtable;
	__this->__construct(dialogueList,song);
	return __this;
}

DialogueBoxEmal_obj::DialogueBoxEmal_obj()
{
}

void DialogueBoxEmal_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(DialogueBoxEmal);
...
void DialogueBoxEmal_obj::__Visit(HX_VISIT_PARAMS)
{
...
::hx::Val DialogueBoxEmal_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
bool DialogueBoxEmal_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 11:
...
::hx::Val DialogueBoxEmal_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
...
bool DialogueBoxEmal_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 11:
...
void DialogueBoxEmal_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::hx::StorageInfo DialogueBoxEmal_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::Alphabet */ ,(int)offsetof(DialogueBoxEmal_obj,dialogue),HX_("dialogue",18,2d,94,a7)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(DialogueBoxEmal_obj,dialogueList),HX_("dialogueList",96,e1,d8,0d)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(DialogueBoxEmal_obj,finishThing),HX_("finishThing",9b,aa,8e,36)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(DialogueBoxEmal_obj,nextDialogueThing),HX_("nextDialogueThing",c3,c2,a1,d9)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(DialogueBoxEmal_obj,skipDialogueThing),HX_("skipDialogueThing",b7,29,12,4e)},
	{::hx::fsObject /*  ::flixel::FlxSprite */ ,(int)offsetof(DialogueBoxEmal_obj,bgFade),HX_("bgFade",e1,fd,cd,ab)},
	{::hx::fsObject /*  ::flixel::FlxSprite */ ,(int)offsetof(DialogueBoxEmal_obj,box),HX_("box",0b,be,4a,00)},
	{::hx::fsString,(int)offsetof(DialogueBoxEmal_obj,textToType),HX_("textToType",62,de,b2,b9)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(DialogueBoxEmal_obj,arrayCharacters),HX_("arrayCharacters",a3,23,67,53)},
	{::hx::fsInt,(int)offsetof(DialogueBoxEmal_obj,currentText),HX_("currentText",86,a5,8b,85)},
	{::hx::fsFloat,(int)offsetof(DialogueBoxEmal_obj,offsetPos),HX_("offsetPos",c1,3b,c0,41)},
	{::hx::fsObject /* ::Array< ::String > */ ,(int)offsetof(DialogueBoxEmal_obj,textBoxTypes),HX_("textBoxTypes",3b,d8,65,ca)},
	{::hx::fsBool,(int)offsetof(DialogueBoxEmal_obj,dialogueStarted),HX_("dialogueStarted",09,77,22,70)},
	{::hx::fsBool,(int)offsetof(DialogueBoxEmal_obj,dialogueEnded),HX_("dialogueEnded",c2,14,61,0b)},
	{::hx::fsInt,(int)offsetof(DialogueBoxEmal_obj,scrollSpeed),HX_("scrollSpeed",3a,e0,46,cb)},
	{::hx::fsObject /*  ::Alphabet */ ,(int)offsetof(DialogueBoxEmal_obj,daText),HX_("daText",ca,52,61,0d)},
	{::hx::fsBool,(int)offsetof(DialogueBoxEmal_obj,ignoreThisFrame),HX_("ignoreThisFrame",7d,81,d2,40)},
	{::hx::fsInt,(int)offsetof(DialogueBoxEmal_obj,lastCharacter),HX_("lastCharacter",73,b6,0a,40)},
	{::hx::fsString,(int)offsetof(DialogueBoxEmal_obj,lastBoxType),HX_("lastBoxType",af,f2,77,51)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo DialogueBoxEmal_obj_sStaticStorageInfo[] = {
	{::hx::fsFloat,(void *) &DialogueBoxEmal_obj::LEFT_CHAR_X,HX_("LEFT_CHAR_X",e7,bb,19,61)},
	{::hx::fsFloat,(void *) &DialogueBoxEmal_obj::RIGHT_CHAR_X,HX_("RIGHT_CHAR_X",d2,58,47,14)},
	{::hx::fsFloat,(void *) &DialogueBoxEmal_obj::DEFAULT_CHAR_Y,HX_("DEFAULT_CHAR_Y",8e,06,1f,4b)},
	{::hx::fsInt,(void *) &DialogueBoxEmal_obj::DEFAULT_TEXT_X,HX_("DEFAULT_TEXT_X",24,d8,31,6c)},
	{::hx::fsInt,(void *) &DialogueBoxEmal_obj::DEFAULT_TEXT_Y,HX_("DEFAULT_TEXT_Y",25,d8,31,6c)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif

static ::String DialogueBoxEmal_obj_sMemberFields[] = {
...
static void DialogueBoxEmal_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(DialogueBoxEmal_obj::LEFT_CHAR_X,"LEFT_CHAR_X");
	HX_MARK_MEMBER_NAME(DialogueBoxEmal_obj::RIGHT_CHAR_X,"RIGHT_CHAR_X");
	HX_MARK_MEMBER_NAME(DialogueBoxEmal_obj::DEFAULT_CHAR_Y,"DEFAULT_CHAR_Y");
	HX_MARK_MEMBER_NAME(DialogueBoxEmal_obj::DEFAULT_TEXT_X,"DEFAULT_TEXT_X");
	HX_MARK_MEMBER_NAME(DialogueBoxEmal_obj::DEFAULT_TEXT_Y,"DEFAULT_TEXT_Y");
};

#ifdef HXCPP_VISIT_ALLOCS
static void DialogueBoxEmal_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(DialogueBoxEmal_obj::LEFT_CHAR_X,"LEFT_CHAR_X");
	HX_VISIT_MEMBER_NAME(DialogueBoxEmal_obj::RIGHT_CHAR_X,"RIGHT_CHAR_X");
	HX_VISIT_MEMBER_NAME(DialogueBoxEmal_obj::DEFAULT_CHAR_Y,"DEFAULT_CHAR_Y");
	HX_VISIT_MEMBER_NAME(DialogueBoxEmal_obj::DEFAULT_TEXT_X,"DEFAULT_TEXT_X");
	HX_VISIT_MEMBER_NAME(DialogueBoxEmal_obj::DEFAULT_TEXT_Y,"DEFAULT_TEXT_Y");
};

#endif

::hx::Class DialogueBoxEmal_obj::__mClass;

static ::String DialogueBoxEmal_obj_sStaticFields[] = {
...
void DialogueBoxEmal_obj::__register()
{
	DialogueBoxEmal_obj _hx_dummy;
	DialogueBoxEmal_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("DialogueBoxEmal",a6,38,6c,2e);
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &DialogueBoxEmal_obj::__GetStatic;
	__mClass->mSetStaticField = &DialogueBoxEmal_obj::__SetStatic;
	__mClass->mMarkFunc = DialogueBoxEmal_obj_sMarkStatics;
	__mClass->mStatics = ::hx::Class_obj::dupFunctions(DialogueBoxEmal_obj_sStaticFields);
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(DialogueBoxEmal_obj_sMemberFields);
	__mClass->mCanCast = ::hx::TCanCast< DialogueBoxEmal_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = DialogueBoxEmal_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = DialogueBoxEmal_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = DialogueBoxEmal_obj_sStaticStorageInfo;
#endif
	::hx::_hx_RegisterClass(__mClass->mName, __mClass);
}

void DialogueBoxEmal_obj::__boot()
{
{
            	HX_STACKFRAME(&_hx_pos_6a4c75b5b5794831_221_boot)
HXDLIN( 221)		LEFT_CHAR_X = ((Float)-60);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a4c75b5b5794831_222_boot)
HXDLIN( 222)		RIGHT_CHAR_X = ((Float)-100);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a4c75b5b5794831_223_boot)
HXDLIN( 223)		DEFAULT_CHAR_Y = ((Float)60);
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a4c75b5b5794831_273_boot)
HXDLIN( 273)		DEFAULT_TEXT_X = 90;
            	}
{
            	HX_STACKFRAME(&_hx_pos_6a4c75b5b5794831_274_boot)
