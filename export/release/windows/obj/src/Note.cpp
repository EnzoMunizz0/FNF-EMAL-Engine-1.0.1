...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_296_loadPixelNoteAnims,"Note","loadPixelNoteAnims",0xefd7042c,"Note.loadPixelNoteAnims","Note.hx",296,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_315_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",315,0x1a8855ec)
...
HXDLIN( 196)					_g->set_y((_g->y * (((::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)1.05)) * ::PlayState_obj::songSpeed)));
            				}
...
HXDLIN( 249)			this->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp * ::ClientPrefs_obj::noteSize) * ::PlayState_obj::daPixelZoom)),null());
...
HXLINE( 291)		Float _hx_tmp = this->get_width();
HXDLIN( 291)		this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::ClientPrefs_obj::noteSize)),null());
...
void Note_obj::loadPixelNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_296_loadPixelNoteAnims)
HXDLIN( 296)		if (this->isSustainNote) {
HXLINE( 297)			this->animation->add(HX_("purpleholdend",40,d5,15,5b),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
HXLINE( 298)			this->animation->add(HX_("greenholdend",99,eb,5f,39),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 299)			this->animation->add(HX_("redholdend",cb,ae,1e,ea),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 300)			this->animation->add(HX_("blueholdend",a2,f0,cd,25),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 302)			this->animation->add(HX_("purplehold",7b,8d,da,cd),::Array_obj< int >::__new(1)->init(0,::Note_obj::PURP_NOTE),null(),null(),null(),null());
HXLINE( 303)			this->animation->add(HX_("greenhold",82,f5,c1,bc),::Array_obj< int >::__new(1)->init(0,::Note_obj::GREEN_NOTE),null(),null(),null(),null());
HXLINE( 304)			this->animation->add(HX_("redhold",10,1f,bf,bf),::Array_obj< int >::__new(1)->init(0,::Note_obj::RED_NOTE),null(),null(),null(),null());
HXLINE( 305)			this->animation->add(HX_("bluehold",d9,60,aa,a4),::Array_obj< int >::__new(1)->init(0,::Note_obj::BLUE_NOTE),null(),null(),null(),null());
            		}
            		else {
HXLINE( 307)			this->animation->add(HX_("greenScroll",30,4f,fe,9e),::Array_obj< int >::__new(1)->init(0,(::Note_obj::GREEN_NOTE + 4)),null(),null(),null(),null());
HXLINE( 308)			this->animation->add(HX_("redScroll",3e,78,c3,3a),::Array_obj< int >::__new(1)->init(0,(::Note_obj::RED_NOTE + 4)),null(),null(),null(),null());
HXLINE( 309)			this->animation->add(HX_("blueScroll",47,7e,59,a2),::Array_obj< int >::__new(1)->init(0,(::Note_obj::BLUE_NOTE + 4)),null(),null(),null(),null());
HXLINE( 310)			this->animation->add(HX_("purpleScroll",69,97,67,99),::Array_obj< int >::__new(1)->init(0,(::Note_obj::PURP_NOTE + 4)),null(),null(),null(),null());
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_315_update)
HXLINE( 316)		this->super::update(elapsed);
HXLINE( 318)		if (this->mustPress) {
HXLINE( 321)			bool _hx_tmp;
HXDLIN( 321)			if ((this->strumTime > (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 321)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)));
            			}
            			else {
HXLINE( 321)				_hx_tmp = false;
            			}
HXDLIN( 321)			if (_hx_tmp) {
HXLINE( 323)				this->canBeHit = true;
            			}
            			else {
HXLINE( 325)				this->canBeHit = false;
            			}
HXLINE( 327)			bool _hx_tmp1;
HXDLIN( 327)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 327)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 327)				_hx_tmp1 = false;
            			}
HXDLIN( 327)			if (_hx_tmp1) {
HXLINE( 328)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 332)			this->canBeHit = false;
HXLINE( 334)			if ((this->strumTime <= ::Conductor_obj::songPosition)) {
HXLINE( 335)				this->wasGoodHit = true;
            			}
            		}
HXLINE( 338)		if (this->tooLate) {
HXLINE( 340)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 341)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
