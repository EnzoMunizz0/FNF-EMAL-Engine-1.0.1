...
HX_DEFINE_STACK_FRAME(_hx_pos_dbfed37df9f2f296_54_new,"DialogueCharacter","new",0x232608c3,"DialogueCharacter.new","DialogueBoxEmal.hx",54,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_83_reloadCharacterJson,"DialogueCharacter","reloadCharacterJson",0x855c59bb,"DialogueCharacter.reloadCharacterJson","DialogueBoxEmal.hx",83,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_106_reloadAnimations,"DialogueCharacter","reloadAnimations",0xc9b79b65,"DialogueCharacter.reloadAnimations","DialogueBoxEmal.hx",106,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_117_playAnim,"DialogueCharacter","playAnim",0x25fc6ae2,"DialogueCharacter.playAnim","DialogueBoxEmal.hx",117,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_152_animationIsLoop,"DialogueCharacter","animationIsLoop",0x9ed1aa75,"DialogueCharacter.animationIsLoop","DialogueBoxEmal.hx",152,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_56_boot,"DialogueCharacter","boot",0x963aa26f,"DialogueCharacter.boot","DialogueBoxEmal.hx",56,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_57_boot,"DialogueCharacter","boot",0x963aa26f,"DialogueCharacter.boot","DialogueBoxEmal.hx",57,0x0ee375d8)
HX_LOCAL_STACK_FRAME(_hx_pos_dbfed37df9f2f296_58_boot,"DialogueCharacter","boot",0x963aa26f,"DialogueCharacter.boot","DialogueBoxEmal.hx",58,0x0ee375d8)

void DialogueCharacter_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::String character){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_dbfed37df9f2f296_54_new)
...
void DialogueCharacter_obj::reloadCharacterJson(::String character){
            	HX_GC_STACKFRAME(&_hx_pos_dbfed37df9f2f296_83_reloadCharacterJson)
...
void DialogueCharacter_obj::reloadAnimations(){
            	HX_STACKFRAME(&_hx_pos_dbfed37df9f2f296_106_reloadAnimations)
...
void DialogueCharacter_obj::playAnim(::String animName,::hx::Null< bool >  __o_playIdle){
            	...
            	HX_STACKFRAME(&_hx_pos_dbfed37df9f2f296_117_playAnim)
...
HXDLIN( 148)			::haxe::Log_obj::trace((((HX_("Offsets not found! Dialogue character is badly formatted, anim: ",ce,cc,78,b6) + leAnim) + HX_(", ",74,26,00,00)) + _hx_tmp),::hx::SourceInfo(HX_("source/DialogueBoxEmal.hx",cc,51,ff,55),148,HX_("DialogueCharacter",51,eb,23,69),HX_("playAnim",25,ea,84,30)));
            		}
            	}
...
bool DialogueCharacter_obj::animationIsLoop(){
            	HX_STACKFRAME(&_hx_pos_dbfed37df9f2f296_152_animationIsLoop)
...
{
{
            	HX_STACKFRAME(&_hx_pos_dbfed37df9f2f296_56_boot)
HXDLIN(  56)		IDLE_SUFFIX = HX_("-IDLE",c1,89,7c,19);
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfed37df9f2f296_57_boot)
HXDLIN(  57)		DEFAULT_CHARACTER = HX_("bf",c4,55,00,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_dbfed37df9f2f296_58_boot)
