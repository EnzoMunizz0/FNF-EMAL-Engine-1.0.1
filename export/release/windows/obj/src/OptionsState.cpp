...
static const ::String _hx_array_data_0f8009f3_1[] = {
	HX_("Notes",21,4c,f8,32),HX_("Controls",96,42,6e,11),HX_("Preferences",98,4e,23,57),HX_("SoundFart",0c,6e,56,f0),
};
...
HXDLIN( 101)				goto _hx_goto_6;
            			...
            			if (  (_hx_switch_0==HX_("SoundFart",0c,6e,56,f0)) ){
HXLINE( 104)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 104)				_hx_tmp->play(::Paths_obj::sound(HX_("fartsoundlol",d7,b9,d1,56),null()),null(),null(),null(),null(),null());
HXLINE( 105)				::MusicBeatState_obj::switchState( ::OptionsState_obj::__alloc( HX_CTX ,null(),null()));
