...
HX_LOCAL_STACK_FRAME(_hx_pos_451d99b3fc57d4a2_148_updateConfirmOffset,"StrumNote","updateConfirmOffset",0x9095aeb7,"StrumNote.updateConfirmOffset","StrumNote.hx",148,0x345a6fe3)
...
HXDLIN(  40)			this->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp3 * ::ClientPrefs_obj::noteSize) * ::PlayState_obj::daPixelZoom)),null());
...
HXLINE( 125)		this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
HXLINE( 126)		bool _hx_tmp;
HXDLIN( 126)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 126)			_hx_tmp = (this->animation->_curAnim->name == HX_("static",ae,dc,fb,05));
            		}
            		else {
HXLINE( 126)			_hx_tmp = true;
            		}
HXDLIN( 126)		if (_hx_tmp) {
HXLINE( 127)			this->colorSwap->set_hue(( (Float)(0) ));
HXLINE( 128)			this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE( 129)			this->colorSwap->set_brightness(( (Float)(0) ));
            		}
            		else {
HXLINE( 131)			this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE( 132)			this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE( 133)			this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
HXLINE( 135)			bool _hx_tmp;
HXDLIN( 135)			if ((this->animation->_curAnim->name == HX_("confirm",00,9d,39,10))) {
HXLINE( 135)				_hx_tmp = !(::PlayState_obj::isPixelStage);
            			}
            			else {
HXLINE( 135)				_hx_tmp = false;
            			}
HXDLIN( 135)			if (_hx_tmp) {
HXLINE( 136)				this->updateConfirmOffset();
            			}
            		}
            	}
...
void StrumNote_obj::updateConfirmOffset(){
            	HX_STACKFRAME(&_hx_pos_451d99b3fc57d4a2_148_updateConfirmOffset)
HXDLIN( 148)		this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
            	}
