...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_108_browse,"lime.ui.FileDialog","browse",0xc1264193,"lime.ui.FileDialog.browse","lime/ui/FileDialog.hx",108,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_181_browse,"lime.ui.FileDialog","browse",0xc1264193,"lime.ui.FileDialog.browse","lime/ui/FileDialog.hx",181,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_100_browse,"lime.ui.FileDialog","browse",0xc1264193,"lime.ui.FileDialog.browse","lime/ui/FileDialog.hx",100,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_241_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",241,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_258_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",258,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_236_open,"lime.ui.FileDialog","open",0x8e9b2393,"lime.ui.FileDialog.open","lime/ui/FileDialog.hx",236,0x296febf9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_326_save,"lime.ui.FileDialog","save",0x9134ab06,"lime.ui.FileDialog.save","lime/ui/FileDialog.hx",326,0x296febf9)
HX_LOCAL_STACK_FRAME(_hx_pos_9e2e2667a273619d_298_save,"lime.ui.FileDialog","save",0x9134ab06,"lime.ui.FileDialog.save","lime/ui/FileDialog.hx",298,0x296febf9)
namespace lime{
namespace ui{
...
bool FileDialog_obj::browse( ::lime::ui::FileDialogType type,::String filter,::String defaultPath,::String title){
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_108_browse)
HXLINE( 108)			switch((int)(type->_hx_getIndex())){
            				case (int)0: {
HXLINE( 115)					 ::hx::Object * path = ::hx::DynamicPtr(null());
...
HXLINE( 145)					worker->sendComplete(( ( ::Dynamic)(paths) ));
            				...
            				break;
            				case (int)2: {
HXLINE( 167)					 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 172)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 175)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 152)					 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 157)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title,filter,defaultPath);
HXLINE( 160)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            			}
            		}
            		...
            		void _hx_run( ::Dynamic result){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_181_browse)
HXLINE( 181)			switch((int)(type->_hx_getIndex())){
            				case (int)1: {
HXLINE( 202)					::Array< ::String > paths = ( (::Array< ::String >)(result) );
HXLINE( 204)					bool _hx_tmp;
HXDLIN( 204)					if (::hx::IsNotNull( paths )) {
HXLINE( 204)						_hx_tmp = (paths->length > 0);
            					}
            					else {
HXLINE( 204)						_hx_tmp = false;
            					}
HXDLIN( 204)					if (_hx_tmp) {
HXLINE( 206)						_gthis->onSelectMultiple->dispatch(paths);
            					}
            					else {
HXLINE( 210)						_gthis->onCancel->dispatch();
            					}
            				}
            				break;
            				case (int)0: case (int)2: case (int)3: {
HXLINE( 184)					::String path = ( (::String)(result) );
HXLINE( 186)					if (::hx::IsNotNull( path )) {
HXLINE( 189)						bool _hx_tmp;
HXDLIN( 189)						bool _hx_tmp1;
HXDLIN( 189)						if (::hx::IsEq( type,::lime::ui::FileDialogType_obj::SAVE_dyn() )) {
HXLINE( 189)							_hx_tmp1 = ::hx::IsNotNull( filter );
            						}
            						else {
HXLINE( 189)							_hx_tmp1 = false;
            						}
HXDLIN( 189)						if (_hx_tmp1) {
HXLINE( 189)							_hx_tmp = (path.indexOf(HX_(".",2e,00,00,00),null()) == -1);
            						}
            						else {
HXLINE( 189)							_hx_tmp = false;
            						}
HXDLIN( 189)						if (_hx_tmp) {
HXLINE( 191)							path = (path + (HX_(".",2e,00,00,00) + filter));
            						}
HXLINE( 194)						_gthis->onSelect->dispatch(path);
            					}
            					else {
HXLINE( 198)						_gthis->onCancel->dispatch();
            					}
            				}
            				break;
            			}
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_100_browse)
HXLINE(  99)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 101)		if (::hx::IsNull( type )) {
HXLINE( 101)			type = ::lime::ui::FileDialogType_obj::OPEN_dyn();
            		}
HXLINE( 104)		 ::lime::_hx_system::BackgroundWorker worker =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
HXLINE( 106)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(type,title,worker,filter,defaultPath)),null(),null());
HXLINE( 179)		worker->onComplete->add( ::Dynamic(new _hx_Closure_1(_gthis,type,filter)),null(),null());
HXLINE( 215)		worker->run(null());
...
bool FileDialog_obj::open(::String filter,::String defaultPath,::String title){
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_241_open)
HXLINE( 246)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 251)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title,filter,defaultPath);
HXLINE( 254)			worker->sendComplete(( ( ::Dynamic)(path) ));
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::lime::ui::FileDialog,_gthis) HXARGC(1)
            		void _hx_run(::String path){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_258_open)
HXLINE( 259)			if (::hx::IsNotNull( path )) {
HXLINE( 261)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 263)					 ::haxe::io::Bytes data = ::sys::io::File_obj::getBytes(path);
HXLINE( 264)					_gthis->onOpen->dispatch(data);
HXLINE( 265)					return;
            				} catch( ::Dynamic _hx_e) {
...
HXLINE( 270)			_gthis->onCancel->dispatch();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_236_open)
HXLINE( 235)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 238)		 ::lime::_hx_system::BackgroundWorker worker =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
HXLINE( 240)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(title,worker,filter,defaultPath)),null(),null());
HXLINE( 257)		worker->onComplete->add( ::Dynamic(new _hx_Closure_1(_gthis)),null(),null());
HXLINE( 273)		worker->run(null());
...
HXLINE( 314)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 319)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 322)			worker->sendComplete(( ( ::Dynamic)(path) ));
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_1, ::lime::ui::FileDialog,_gthis, ::haxe::io::Bytes,data) HXARGC(1)
            		void _hx_run(::String path){
            			HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_326_save)
HXLINE( 327)			if (::hx::IsNotNull( path )) {
HXLINE( 329)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 331)					::sys::io::File_obj::saveBytes(path,data);
HXLINE( 332)					_gthis->onSave->dispatch(path);
HXLINE( 333)					return;
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
...
HXLINE( 338)			_gthis->onCancel->dispatch();
            		}
            		HX_END_LOCAL_FUNC1((void))

            		::String type = __o_type;
            		if (::hx::IsNull(__o_type)) type = HX_("application/octet-stream",5d,f8,82,30);
            	HX_GC_STACKFRAME(&_hx_pos_9e2e2667a273619d_298_save)
HXLINE( 297)		 ::lime::ui::FileDialog _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 299)		if (::hx::IsNull( data )) {
HXLINE( 301)			this->onCancel->dispatch();
HXLINE( 302)			return false;
            		}
HXLINE( 306)		 ::lime::_hx_system::BackgroundWorker worker =  ::lime::_hx_system::BackgroundWorker_obj::__alloc( HX_CTX );
HXLINE( 308)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(title,worker,filter,defaultPath)),null(),null());
HXLINE( 325)		worker->onComplete->add( ::Dynamic(new _hx_Closure_1(_gthis,data)),null(),null());
HXLINE( 341)		worker->run(null());
