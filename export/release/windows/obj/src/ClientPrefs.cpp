...
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_35_startControls,"ClientPrefs","startControls",0x3c29e88f,"ClientPrefs.startControls","ClientPrefs.hx",35,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_57_saveSettings,"ClientPrefs","saveSettings",0xab8c0989,"ClientPrefs.saveSettings","ClientPrefs.hx",57,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_89_loadPrefs,"ClientPrefs","loadPrefs",0x58c63c41,"ClientPrefs.loadPrefs","ClientPrefs.hx",89,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_174_reloadControls,"ClientPrefs","reloadControls",0xe353bb78,"ClientPrefs.reloadControls","ClientPrefs.hx",174,0x329d1619)
...
void ClientPrefs_obj::startControls(){
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_35_startControls)
HXLINE(  37)		::ClientPrefs_obj::keyBinds->set(HX_("note_left",b4,fe,20,a5),::cpp::VirtualArray_obj::__new(2)->init(0,65)->init(1,37));
HXLINE(  38)		::ClientPrefs_obj::keyBinds->set(HX_("note_down",0f,ef,de,9f),::cpp::VirtualArray_obj::__new(2)->init(0,83)->init(1,40));
HXLINE(  39)		::ClientPrefs_obj::keyBinds->set(HX_("note_up",c8,67,5c,4d),::cpp::VirtualArray_obj::__new(2)->init(0,87)->init(1,38));
HXLINE(  40)		::ClientPrefs_obj::keyBinds->set(HX_("note_right",8f,ec,ca,4e),::cpp::VirtualArray_obj::__new(2)->init(0,68)->init(1,39));
HXLINE(  42)		::ClientPrefs_obj::keyBinds->set(HX_("ui_left",12,4d,89,f7),::cpp::VirtualArray_obj::__new(2)->init(0,65)->init(1,37));
HXLINE(  43)		::ClientPrefs_obj::keyBinds->set(HX_("ui_down",6d,3d,47,f2),::cpp::VirtualArray_obj::__new(2)->init(0,83)->init(1,40));
HXLINE(  44)		::ClientPrefs_obj::keyBinds->set(HX_("ui_up",a6,c2,91,a3),::cpp::VirtualArray_obj::__new(2)->init(0,87)->init(1,38));
HXLINE(  45)		::ClientPrefs_obj::keyBinds->set(HX_("ui_right",71,30,a7,17),::cpp::VirtualArray_obj::__new(2)->init(0,68)->init(1,39));
HXLINE(  47)		::ClientPrefs_obj::keyBinds->set(HX_("accept",08,93,06,0b),::cpp::VirtualArray_obj::__new(2)->init(0,32)->init(1,13));
HXLINE(  48)		::ClientPrefs_obj::keyBinds->set(HX_("back",27,da,10,41),::cpp::VirtualArray_obj::__new(2)->init(0,8)->init(1,27));
HXLINE(  49)		::ClientPrefs_obj::keyBinds->set(HX_("pause",f6,d6,57,bd),::cpp::VirtualArray_obj::__new(2)->init(0,13)->init(1,27));
HXLINE(  50)		::ClientPrefs_obj::keyBinds->set(HX_("reset",cf,49,c8,e6),::cpp::VirtualArray_obj::__new(2)->init(0,82)->init(1,-1));
HXLINE(  54)		::ClientPrefs_obj::defaultKeys = ::ClientPrefs_obj::keyBinds->copy();
            	}
...
void ClientPrefs_obj::saveSettings(){
            	HX_GC_STACKFRAME(&_hx_pos_1453641688f31b8d_57_saveSettings)
HXLINE(  58)		::flixel::FlxG_obj::save->data->__SetField(HX_("downScroll",0f,ba,68,84),::ClientPrefs_obj::downScroll,::hx::paccDynamic);
HXLINE(  59)		::flixel::FlxG_obj::save->data->__SetField(HX_("middleScroll",42,cd,58,62),::ClientPrefs_obj::middleScroll,::hx::paccDynamic);
HXLINE(  60)		::flixel::FlxG_obj::save->data->__SetField(HX_("showFPS",ec,0a,9a,7b),::ClientPrefs_obj::showFPS,::hx::paccDynamic);
HXLINE(  61)		::flixel::FlxG_obj::save->data->__SetField(HX_("flashing",32,85,e8,99),::ClientPrefs_obj::flashing,::hx::paccDynamic);
HXLINE(  62)		::flixel::FlxG_obj::save->data->__SetField(HX_("globalAntialiasing",f7,9c,ed,4c),::ClientPrefs_obj::globalAntialiasing,::hx::paccDynamic);
HXLINE(  63)		::flixel::FlxG_obj::save->data->__SetField(HX_("noteSplashes",a7,57,29,8d),::ClientPrefs_obj::noteSplashes,::hx::paccDynamic);
HXLINE(  64)		::flixel::FlxG_obj::save->data->__SetField(HX_("lowQuality",8b,52,27,3e),::ClientPrefs_obj::lowQuality,::hx::paccDynamic);
HXLINE(  65)		::flixel::FlxG_obj::save->data->__SetField(HX_("framerate",8d,e5,4b,4e),::ClientPrefs_obj::framerate,::hx::paccDynamic);
HXLINE(  68)		::flixel::FlxG_obj::save->data->__SetField(HX_("speed",87,97,69,81),::ClientPrefs_obj::speed,::hx::paccDynamic);
HXLINE(  69)		::flixel::FlxG_obj::save->data->__SetField(HX_("scroll",0d,d8,64,47),::ClientPrefs_obj::scroll,::hx::paccDynamic);
HXLINE(  70)		::flixel::FlxG_obj::save->data->__SetField(HX_("noteSize",d3,c5,86,5b),::ClientPrefs_obj::noteSize,::hx::paccDynamic);
HXLINE(  71)		::flixel::FlxG_obj::save->data->__SetField(HX_("camZooms",71,f3,cd,90),::ClientPrefs_obj::camZooms,::hx::paccDynamic);
HXLINE(  72)		::flixel::FlxG_obj::save->data->__SetField(HX_("noteOffset",25,a5,53,fe),::ClientPrefs_obj::noteOffset,::hx::paccDynamic);
HXLINE(  73)		::flixel::FlxG_obj::save->data->__SetField(HX_("hideHud",15,b9,3c,b7),::ClientPrefs_obj::hideHud,::hx::paccDynamic);
HXLINE(  74)		::flixel::FlxG_obj::save->data->__SetField(HX_("arrowHSV",c2,f4,b4,fd),::ClientPrefs_obj::arrowHSV,::hx::paccDynamic);
HXLINE(  75)		::flixel::FlxG_obj::save->data->__SetField(HX_("imagesPersist",3c,00,5c,08),::ClientPrefs_obj::imagesPersist,::hx::paccDynamic);
HXLINE(  76)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghostTapping",c6,6a,da,10),::ClientPrefs_obj::ghostTapping,::hx::paccDynamic);
HXLINE(  77)		::flixel::FlxG_obj::save->data->__SetField(HX_("hideTime",ef,b5,ca,a5),::ClientPrefs_obj::hideTime,::hx::paccDynamic);
HXLINE(  78)		::flixel::FlxG_obj::save->data->__SetField(HX_("achievementsMap",d8,6f,d5,91),::Achievements_obj::achievementsMap,::hx::paccDynamic);
HXLINE(  79)		::flixel::FlxG_obj::save->data->__SetField(HX_("henchmenDeath",f4,76,2a,dd),::Achievements_obj::henchmenDeath,::hx::paccDynamic);
HXLINE(  80)		::flixel::FlxG_obj::save->flush(null(),null());
HXLINE(  82)		 ::flixel::util::FlxSave save =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE(  83)		save->bind(HX_("controls_v2",65,e4,a2,26),HX_("ninjamuffin99",f7,4c,e5,00));
HXLINE(  84)		save->data->__SetField(HX_("customControls",47,63,49,5a),::ClientPrefs_obj::keyBinds,::hx::paccDynamic);
HXLINE(  85)		save->flush(null(),null());
            	}
...
void ClientPrefs_obj::loadPrefs(){
            	HX_GC_STACKFRAME(&_hx_pos_1453641688f31b8d_89_loadPrefs)
HXLINE(  90)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("downScroll",0f,ba,68,84),::hx::paccDynamic) )) {
HXLINE(  91)			::ClientPrefs_obj::downScroll = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downScroll",0f,ba,68,84),::hx::paccDynamic)) );
            		}
HXLINE(  93)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("middleScroll",42,cd,58,62),::hx::paccDynamic) )) {
HXLINE(  94)			::ClientPrefs_obj::middleScroll = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("middleScroll",42,cd,58,62),::hx::paccDynamic)) );
            		}
HXLINE(  96)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("showFPS",ec,0a,9a,7b),::hx::paccDynamic) )) {
HXLINE(  97)			::ClientPrefs_obj::showFPS = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("showFPS",ec,0a,9a,7b),::hx::paccDynamic)) );
HXLINE(  98)			if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE(  99)				::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            			}
            		}
HXLINE( 102)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic) )) {
HXLINE( 103)			::ClientPrefs_obj::flashing = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) );
            		}
HXLINE( 105)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("globalAntialiasing",f7,9c,ed,4c),::hx::paccDynamic) )) {
HXLINE( 106)			::ClientPrefs_obj::globalAntialiasing = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("globalAntialiasing",f7,9c,ed,4c),::hx::paccDynamic)) );
            		}
HXLINE( 108)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("noteSplashes",a7,57,29,8d),::hx::paccDynamic) )) {
HXLINE( 109)			::ClientPrefs_obj::noteSplashes = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("noteSplashes",a7,57,29,8d),::hx::paccDynamic)) );
            		}
HXLINE( 111)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("lowQuality",8b,52,27,3e),::hx::paccDynamic) )) {
HXLINE( 112)			::ClientPrefs_obj::lowQuality = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("lowQuality",8b,52,27,3e),::hx::paccDynamic)) );
            		}
HXLINE( 114)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic) )) {
HXLINE( 115)			::ClientPrefs_obj::framerate = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic)) );
HXLINE( 116)			if ((::ClientPrefs_obj::framerate > ::flixel::FlxG_obj::drawFramerate)) {
HXLINE( 117)				::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
HXLINE( 118)				::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
            			}
            			else {
HXLINE( 120)				::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
HXLINE( 121)				::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
            			}
            		}
HXLINE( 130)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("camZooms",71,f3,cd,90),::hx::paccDynamic) )) {
HXLINE( 131)			::ClientPrefs_obj::camZooms = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camZooms",71,f3,cd,90),::hx::paccDynamic)) );
            		}
HXLINE( 133)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("hideHud",15,b9,3c,b7),::hx::paccDynamic) )) {
HXLINE( 134)			::ClientPrefs_obj::hideHud = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("hideHud",15,b9,3c,b7),::hx::paccDynamic)) );
            		}
HXLINE( 136)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("noteOffset",25,a5,53,fe),::hx::paccDynamic) )) {
HXLINE( 137)			::ClientPrefs_obj::noteOffset = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("noteOffset",25,a5,53,fe),::hx::paccDynamic)) );
            		}
HXLINE( 139)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("arrowHSV",c2,f4,b4,fd),::hx::paccDynamic) )) {
HXLINE( 140)			::ClientPrefs_obj::arrowHSV = ( (::Array< ::Dynamic>)(::flixel::FlxG_obj::save->data->__Field(HX_("arrowHSV",c2,f4,b4,fd),::hx::paccDynamic)) );
            		}
HXLINE( 142)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic) )) {
HXLINE( 143)			::ClientPrefs_obj::speed = ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) );
            		}
HXLINE( 145)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("scroll",0d,d8,64,47),::hx::paccDynamic) )) {
HXLINE( 146)			::ClientPrefs_obj::scroll = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scroll",0d,d8,64,47),::hx::paccDynamic)) );
            		}
HXLINE( 148)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("noteSize",d3,c5,86,5b),::hx::paccDynamic) )) {
HXLINE( 149)			::ClientPrefs_obj::noteSize = ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("noteSize",d3,c5,86,5b),::hx::paccDynamic)) );
            		}
HXLINE( 151)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("imagesPersist",3c,00,5c,08),::hx::paccDynamic) )) {
HXLINE( 152)			::ClientPrefs_obj::imagesPersist = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("imagesPersist",3c,00,5c,08),::hx::paccDynamic)) );
HXLINE( 153)			::flixel::graphics::FlxGraphic_obj::defaultPersist = ::ClientPrefs_obj::imagesPersist;
            		}
HXLINE( 155)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("ghostTapping",c6,6a,da,10),::hx::paccDynamic) )) {
HXLINE( 156)			::ClientPrefs_obj::ghostTapping = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghostTapping",c6,6a,da,10),::hx::paccDynamic)) );
            		}
HXLINE( 158)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("hideTime",ef,b5,ca,a5),::hx::paccDynamic) )) {
HXLINE( 159)			::ClientPrefs_obj::hideTime = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("hideTime",ef,b5,ca,a5),::hx::paccDynamic)) );
            		}
HXLINE( 162)		 ::flixel::util::FlxSave save =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE( 163)		save->bind(HX_("controls_v2",65,e4,a2,26),HX_("ninjamuffin99",f7,4c,e5,00));
HXLINE( 164)		bool _hx_tmp;
HXDLIN( 164)		if (::hx::IsNotNull( save )) {
HXLINE( 164)			_hx_tmp = ::hx::IsNotNull( save->data->__Field(HX_("customControls",47,63,49,5a),::hx::paccDynamic) );
            		}
            		else {
HXLINE( 164)			_hx_tmp = false;
            		}
HXDLIN( 164)		if (_hx_tmp) {
HXLINE( 165)			 ::haxe::ds::StringMap loadedControls = ( ( ::haxe::ds::StringMap)(save->data->__Field(HX_("customControls",47,63,49,5a),::hx::paccDynamic)) );
HXLINE( 166)			{
HXLINE( 166)				 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,loadedControls);
HXDLIN( 166)				while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 166)					 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 166)					::String control = ( (::String)(_g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN( 166)					 ::Dynamic keys =  ::Dynamic(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic));
HXLINE( 167)					::ClientPrefs_obj::keyBinds->set(control,keys);
            				}
            			}
HXLINE( 169)			::ClientPrefs_obj::reloadControls();
            		}
            	}
...
void ClientPrefs_obj::reloadControls(){
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_174_reloadControls)
HXDLIN( 174)		::PlayerSettings_obj::player1->controls->setKeyboardScheme(::KeyboardScheme_obj::Solo_dyn(),null());
            	}
...
{
            	HX_GC_STACKFRAME(&_hx_pos_1453641688f31b8d_32_boot)
HXDLIN(  32)		keyBinds =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
}
