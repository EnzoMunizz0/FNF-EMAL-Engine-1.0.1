...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("EMALEngine",75,db,f5,55),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("EnzoMunizz0",cf,13,6c,95));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("EMALEngine",75,db,f5,55));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': EMAL Engine",9c,04,72,59));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.enzomunizz.psychengine",dd,46,1e,d0));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': EMAL Engine",9c,04,72,59))
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),327680)
