...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("EMALEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("EMALEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "EnzoMunizz0";
		app.meta["file"] = "EMALEngine";
		app.meta["name"] = "Friday Night Funkin': EMAL Engine";
		app.meta["packageName"] = "com.enzomunizz.psychengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': EMAL Engine",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif !air
		app.window.context.attributes.background = 327680;
