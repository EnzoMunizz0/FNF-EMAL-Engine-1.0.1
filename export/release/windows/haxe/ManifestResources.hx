...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_fartsoundlol_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__mods_stages_examplestage_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__mods_stages_examplestage_lua extends null { }
